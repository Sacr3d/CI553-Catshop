 ...
 * progressed through the system. This is achieved by holding 3 seperate lists
 * of orders, each list represents a specific stage in the orders life cycle.
 * These stages are: <BR>
...
public class OrderX implements OrderProcessing {
	...
	/**
	 * Returns an order to pick from the warehouse. However if there is no order
	 * avilable then return null.
	 * 
	 ...
	 * processing system This consists of a map with the orders in the 3 states:
